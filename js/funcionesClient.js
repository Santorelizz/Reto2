function traerInformacionClient(){
    $.ajax({
        url:"https://gd0bdfcd75828c7-cloud.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionClient(){
    ...
    $.ajax({
        url:"https://https://gd0bdfcd75828c7-cloud.adb.us-sanjose-1.oraclecloudapps.com/ords/admin/client/client",
        type:"POST",
        data:myData,
        datatype:"JSON",
        success:function(respuesta){
